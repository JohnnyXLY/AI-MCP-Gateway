package cn.johnnyxly.domain.session.model.valobj.enums;
...
public enum SessionMessageHandlerMethodEnum {
     ...
     * 根据方法名获取枚举
     * @param method 方法名
     * @return 相应的枚举对象，若未匹配则返回空
     */
    public static SessionMessageHandlerMethodEnum getByMethod(String method) {
        for (SessionMessageHandlerMethodEnum value : SessionMessageHandlerMethodEnum.values()) {
